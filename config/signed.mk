...
ifdef ARCADIA_MAINTAINER
    ifeq ($(filter $(ARCADIA_MAINTAINER), $(OFFICIAL_MAINTAINER)), $(ARCADIA_MAINTAINER))
        $(warning "$(ARCADIA_MAINTAINER) is verified as official maintainer, build as official build.")
